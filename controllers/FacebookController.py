...
class FacebookController:
    ...
    def get_yearly_metrics(self, page_id, page_access_token):
    ...
    def get_facebook_page_metrics(self, page_id, page_access_token, date_str):
        """
        ...
        try:
            ...
            print("📅 Date range for insights:", since, until)
