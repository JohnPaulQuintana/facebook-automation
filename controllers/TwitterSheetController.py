...
class TwitterSpreadsheetController:
    ...
    # hanmdle initalization of Google Sheets service
    ...
    def _get_value_from_column_e(self, values, currency_row_index, currency):
        ...
        def safe_get(offset):
            ...
            try:
                ...
                print(f"Invalid or missing value at row {row_index + 1}")
                return None
    ...
    def _update_sheet_values(self, service, spreadsheet_id, sheet_id, tab_name, 
            ...
            },
            {
                "repeatCell": {
                    "range": {
                        ...
                        "endRowIndex": currency_row_index + 9,
                        "startColumnIndex": 3,
                        "endColumnIndex": 4
                    },
                    "cell": {
        ...
        print(f"Updated values and formatted rows {currency_row_index-1} to {currency_row_index+9}")
        return values_only
    
    def get_twitter_spreadsheet_column(self, spreadsheet_id: str, tab_name: str, currency: str, insights:list, total_followers: int = 0 ,page_type: str = "page"):
        try:
            # Initialize service
            ...
            value_in_column_objects = self._get_value_from_column_e(values, currency_row_index, currency)
    ...
    def transfer_timeline_insight_data(self, spreadsheet_id: str, tab_name: str, insights_data: list, followers: dict, date: str = None):
        try:
